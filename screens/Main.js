            ...
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.titleText1}>Look Me</Text><Text style={styles.titleText2}>Filter</Text>
                    </View>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                ...
                <View style={styles.cameraStyle}>
                    ...
                    <View style={styles.categoryContainer}>
                        <ScrollView style={{ flexDirection: "row" }} horizontal showsHorizontalScrollIndicator={false}>
                            <TouchableOpacity style={this.state.selectedCategory == 'crown' ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selectedCategory: 'crown' })}>
                                <Text>Crown</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={this.state.selectedCategory == 'flower' ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selectedCategory: 'flower' })}>
                                <Text>Flower</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={this.state.selectedCategory == 'hair' ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selectedCategory: 'hair' })}>
                                <Text>Hair</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={this.state.selectedCategory == 'hat' ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selectedCategory: 'hat' })}>
                                <Text>Hat</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={this.state.selectedCategory == 'other' ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selectedCategory: 'other' })}>
                                <Text>Other</Text>
                            </TouchableOpacity>
                        </ScrollView>
                    </View>
                ...
                <View style={styles.framesContainer}>
                    <ScrollView style={{ flexDirection: "row" }} horizontal showsHorizontalScrollIndicator={false}>
                        {
                            data[this.state.selectedCategory].map(filter_data => {
                                return (
